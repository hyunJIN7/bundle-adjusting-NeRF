...
def plot_save_poses(opt,fig,pose,pose_ref=None,path=None,ep=None):
    ...
    setup_3D_plot(ax1,elev=-90,azim=-90,lim=edict(x=(-2,2),y=(-2,2),z=(-2,2)))  #lim=edict(x=(-1,1),y=(-1,1),z=(-1,1))
    setup_3D_plot(ax2,elev=0,azim=-90,lim=edict(x=(-2,2),y=(-2,2),z=(-2,2)))  #lim=edict(x=(-1,1),y=(-1,1),z=(-1,1))
